namespace ABS.Reports.Production
{
    ...
    /// </summary>
    public partial class rptWeavingProductionSummery : Telerik.Reporting.Report
    {
        public rptWeavingProductionSummery()
        {
            //
        ...
        public int departmentId
        {
            get
            {
                return (int)sqlDataSource1.Parameters[10].Value;
            }
            set
            {
                sqlDataSource1.Parameters[10].Value = value;
            }
        }
    }
}