...
namespace ABS.Reports
{
    public class ABSClass
    {
        ...
        public string daysCount(string dodate)
        {
            DateTime ddate = Convert.ToDateTime(dodate.ToString());

            int diffDays = (DateTime.Today.Date - ddate.Date).Days;
