namespace ABS.Reports.Inventory
{
    ...
    /// </summary>
    public partial class rptCSDetail : Telerik.Reporting.Report
    {
        public rptCSDetail()
        {
            //
        ...
        {
            get { return (DateTime)sqlDataSource1.Parameters[2].Value; }
            set { sqlDataSource1.Parameters[2].Value = null; }

        }
        public DateTime endDate 
        {
            get { return (DateTime)sqlDataSource1.Parameters[3].Value; }
            set { sqlDataSource1.Parameters[3].Value = null; }
        ...
        public int CSId
        {
            ...
            set
            {
                sqlDataSource1.Parameters[0].Value = 0;
            }
