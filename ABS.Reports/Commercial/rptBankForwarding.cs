namespace ABS.Reports.Commercial
{
    ...
    /// </summary>
    public partial class rptBankForwarding : Telerik.Reporting.Report
    {
        public rptBankForwarding()
        {
            //
        ...
        public int pramDCID
        {
            get
            {
                return (int)rpt_ComBankForwarding.Parameters[0].Value;
            }
            set
            {
                rpt_ComBankForwarding.Parameters[0].Value = value;
            }
        }
