...
{
    partial class rptBillOfExchange2
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(rptBillOfExchange2));
    ...
    "ments industry.";
            ...
            this.textBox5.Value = "At {Fields.Sight} days sight pay this first of Exchange (First of the same tenor " +
    "and date being unpaid) to the order of {Fields.DCBankName}, {Fields.DCBankBranch" +
    "Name}, {Fields.DCBankAddress}.";
            // 
            // textBox3
            // 
        ...
        private Telerik.Reporting.SqlDataSource rpt_ComBillOfExchange;
