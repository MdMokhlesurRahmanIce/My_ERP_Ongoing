namespace ABS.Reports.Commercial
{
    ...
    /// </summary>
    public partial class rptConcernCertificate : Telerik.Reporting.Report
    {
        public rptConcernCertificate()
        {
            //
        ...
        public int pramDCID
        {
            get
            {
                return (int)rpt_ComConcernCertificate.Parameters[0].Value;
            }
            set
            {
                rpt_ComConcernCertificate.Parameters[0].Value = value;
            }
        }
