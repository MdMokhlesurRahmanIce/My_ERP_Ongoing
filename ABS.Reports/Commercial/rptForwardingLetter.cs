namespace ABS.Reports.Commercial
{
    ...
    /// </summary>
    public partial class rptForwardingLetter : Telerik.Reporting.Report
    {
        ...
        public int pramDCID
        {
            get
            {
                return (int)rpt_ComForwardingLetter.Parameters[0].Value;
            }
            set
            {
                rpt_ComForwardingLetter.Parameters[0].Value = value;
            }
        }
