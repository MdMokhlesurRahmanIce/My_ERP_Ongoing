...
{
    public partial class RPTHDOSummaryWithItem : System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            ...
            {
                ReportViewer1.Report = new rptHDOSummaryWithItem();
                (ReportViewer1.Report as rptHDOSummaryWithItem).StartDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptHDOSummaryWithItem).EndDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtEndDate.Text);
                (ReportViewer1.Report as rptHDOSummaryWithItem).CreateBy = Convert.ToInt16(Session["UserID"]);
                (ReportViewer1.Report as rptHDOSummaryWithItem).CompanyID = Convert.ToInt16(ddlCompany.SelectedValue);
