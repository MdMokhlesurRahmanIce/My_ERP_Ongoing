<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Sales/Reports/RPTSales.Master" AutoEventWireup="true" 
    CodeBehind="RPTHDO.aspx.cs" Inherits="ABS.Web.Areas.Sales.Reports.RPTHDO" %>
                ...
                <div class="widget box">
                    <div class="widget-header">
                        ...
                        <div class="toolbar no-padding">
                            ...
                            HDO NO <asp:DropDownList ID="ddlHDONo" runat="server" Width="250px" class="select2-select-00"></asp:DropDownList>                                
