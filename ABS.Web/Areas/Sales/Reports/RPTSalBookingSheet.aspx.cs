...
{
    public partial class RPTSalBookingSheet : System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            ...
            {
                ReportViewer1.Report = new rptSalBookingSheet();
                (ReportViewer1.Report as rptSalBookingSheet).StartDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptSalBookingSheet).EndDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtEndDate.Text);
                (ReportViewer1.Report as rptSalBookingSheet).CompanyID = Convert.ToInt16(ddlCompany.SelectedValue);
