<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Commercial/Reports/RPTCommercial.Master" AutoEventWireup="true"
    CodeBehind="RptFabricDeliveryStatement.aspx.cs" Inherits="ABS.Web.Areas.Commercial.Reports.RptFabricDeliveryStatement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphCommercialMaster" runat="server">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Fabrics Delivery Statement</h3>
        </div>
        <div class="box-body">
            <table>
                <tr>
