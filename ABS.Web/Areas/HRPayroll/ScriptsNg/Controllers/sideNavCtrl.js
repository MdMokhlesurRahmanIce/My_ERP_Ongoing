...
app.controller('sideNavCtrl', ['$scope', 'sideNavService','$localStorage',function ($scope, sideNavService,$localStorage) {
    var moduleID = 12; // It will come From Dynamic Top Navigation Bar Click Event
    //***************For Menu Permission ******************
