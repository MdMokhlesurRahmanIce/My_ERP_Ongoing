...
namespace ABS.Web.Areas.Accounting.Controllers
{
    public class BankPaymentVoucherController : Controller
    {
        ...
        public BankPaymentVoucherController()
        {
        ...
        public JavaScriptResult Create(ViewModelVoucherMaster vmCpv)
        {
            try
            {
                ...
                var saveMessage= vmCpv.VoucherSave(userId, EmVoucherType.BankVoucher, "BPV");
                ...
                return JavaScript(string.Format("UYResult('{0}','{1}','{2}','{3}')",
                            "Data saved successfully.", "success", "redirect", Url.Content("~/Accounting/BankPaymentVoucher/Create")));
            }
            catch (Exception ex)
            {
                return JavaScript(string.Format("UYResult('{0}','{1}')",
        ...
        public ActionResult Edit(ViewModelVoucherMaster vmCpv)
        {
            ...
            try
            {
                ...
                var editMessage = vmCpv.VoucherEdit(userId, EmVoucherType.BankVoucher, "BPV");
        ...
        public ViewResult BlankResultRow()
        {
            ...
            return View("_BankVoucherDetail", result);
        }
        ...
        {
            List<AccVoucherMaster> soList = _db.AccVoucherMasters.Where(e => e.VoucherTypeId == 2).OrderByDescending(o => o.VoucherNo).ToList();
