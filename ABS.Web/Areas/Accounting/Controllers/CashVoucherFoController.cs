...
{
    public class CashVoucherFoController : Controller
    {
        private readonly ERP_Entities _db;

        public CashVoucherFoController()
        {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                var vmList = vm.GetVoucherListByType((int) EmVoucherType.CashVoucherFactory);
        ...
        public ActionResult Edit(int? id)
        {
            ...
            try
            {
                ...
                var voucher = new ViewModelVoucherMaster();
                 voucher = voucher.GetVoucherById(Convert.ToInt32(id), (int)EmVoucherType.CashVoucherFactory);
        ...
        public ActionResult Edit(ViewModelVoucherMaster vmCpv)
        {
            ...
            try
            {
                ...
                var editMessage = vmCpv.VoucherEdit(userId, EmVoucherType.CashVoucherHeadOffice, "CPVF");
        ...
        {
            List<AccVoucherMaster> soList = _db.AccVoucherMasters.Where(e => e.VoucherTypeId == 6).OrderByDescending(o => o.VoucherNo).ToList();
