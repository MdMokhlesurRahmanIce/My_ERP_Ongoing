...
namespace ABS.Web.Areas.Accounting.Controllers
{
    public class CashVoucherController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
               ...
               var vmList = vm.GetVoucherListByType((int)EmVoucherType.CashVoucherHeadOffice);
        ...
        public JavaScriptResult Create(ViewModelVoucherMaster vmCpv)
        {
            try
            {
                ...
                var saveMessage = vmCpv.VoucherSave(userId, EmVoucherType.CashVoucherHeadOffice, "CPVH");
                ...
                return JavaScript(string.Format("UYResult('{0}','{1}','{2}','{3}')",
                    "Data saved successfully.", "success", "redirect", Url.Content("~/Accounting/CashVoucher/Create")));
            }
            catch (Exception ex)
            {
                return JavaScript(string.Format("UYResult('{0}','{1}')",
        ...
        public ActionResult Edit(int? id)
        {
            ...
            try
            {
                ...
                voucher = voucher.GetVoucherById(Convert.ToInt32(id), (int)EmVoucherType.CashVoucherHeadOffice);
        ...
        public ActionResult Edit(ViewModelVoucherMaster vmCpv)
        {
            ...
            try
            {
                ...
                var editMessage = vmCpv.VoucherEdit(userId, EmVoucherType.CashVoucherHeadOffice, "CPV");
        ...
        public ViewResult BlankResultRow()
        {
            ...
            return View("_CashVoucherDetail", result);
        }
        ...
        public JsonResult GetCostCenter()
        {
            return Json(new SelectList(from r in _db.AccCostCenterInfoes.ToList()
                                       orderby r.CostCenterName ascending
        ...
        {
            List<AccVoucherMaster> soList = _db.AccVoucherMasters.Where(e => e.VoucherTypeId == 1).OrderByDescending(o => o.VoucherNo).ToList();
    ...
    public partial class JQueryDataTableParamModel
    {
        /// <summary>
