<%@ Page Language="C#" MasterPageFile="~/Areas/Accounting/Reports/RPTAccounting.Master" AutoEventWireup="true" CodeBehind="ReceiptVoucher.aspx.cs" Inherits="ABS.Web.Areas.Accounting.Reports.ReceiptVoucher" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function WarningMessage() {
            UYResult("Please Select a Receipt VoucherNo", "warning");
        }
            ...
            <div class="col-md-12">
                <div class="widget box">
                    <div class="widget-header">
                        <h4><i class="icon-reorder"></i>Receipt Voucher</h4>
                    </div>
