    ...
    public partial class ContraVoucher : System.Web.UI.Page
    {
        ...
        private void BindPV(int companyId)
        {
            try
            {
                using (var db = new ERP_Entities())
                {
                    var source = db.AccVoucherMasters.Where(r => r.VoucherTypeId == 4 && r.CompanyId == companyId).ToList();
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ReportViewer1.Report = new ContraVoucherNew();

                    (ReportViewer1.Report as ContraVoucherNew).pvparam = cbPVNO.SelectedValue;
                    (ReportViewer1.Report as ContraVoucherNew).pvparam1 = ddlCompanyName.SelectedValue;
