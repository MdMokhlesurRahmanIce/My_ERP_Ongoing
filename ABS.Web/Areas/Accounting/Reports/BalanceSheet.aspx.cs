...
namespace ABS.Web.Areas.Accounting.Reports
{
    public partial class BalanceSheet : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            {
                ReportViewer1.Report = new BalanceSheetReport();
                (ReportViewer1.Report as BalanceSheetReport).pvparam1 = UniqueCode.GetDateFormat_MM_dd_yyy(dpStartdate.Value);
                (ReportViewer1.Report as BalanceSheetReport).pvparam2 = UniqueCode.GetDateFormat_MM_dd_yyy(dpEnddate.Value);
                (ReportViewer1.Report as BalanceSheetReport).pvparam = Convert.ToInt32(ddlCompanyName.SelectedValue);
