<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/Areas/Accounting/Reports/RPTAccounting.Master" CodeBehind="CashPVReportByVoucherNo.aspx.cs" Inherits="ABS.Web.Areas.Accounting.Reports.CashPVReportByVoucherNo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            //$("#cbPVNO").append($("<option></option>"));
            $("#cbPVNO").select2({
                placeholder: "Select a Voucher No",
                allowClear: true
            });
        ...
        function WarningMessage() {
            UYResult("Please Select a cash Payment VoucherNo", "warning");
        }
            ...
            <div class="col-md-12">
                <div class="widget box">
                    <div class="widget-header">
                        <h4><i class="icon-reorder"></i>Payment Voucher (Cash)</h4>
                    </div>
