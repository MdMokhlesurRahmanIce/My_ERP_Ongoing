    ...
    public partial class ReceiptVoucher : System.Web.UI.Page
    {
        ...
        private void BindPV(int companyId)
        {
            try
            {
                using (var db = new ERP_Entities())
                {
                    var source = db.AccVoucherMasters.Where(r => r.VoucherTypeId == 3 && r.CompanyId == companyId).ToList();
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ReportViewer1.Report = new ReceivedVoucherNew();
                    (ReportViewer1.Report as ReceivedVoucherNew).pvparam = cbPVNO.SelectedValue;
                    (ReportViewer1.Report as ReceivedVoucherNew).pvparam1 = ddlCompanyName.SelectedValue;
