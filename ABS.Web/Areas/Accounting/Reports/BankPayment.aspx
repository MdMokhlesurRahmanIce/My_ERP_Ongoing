<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Accounting/Reports/RPTAccounting.Master" AutoEventWireup="true" CodeBehind="BankPayment.aspx.cs" Inherits="ABS.Web.Areas.Accounting.Reports.BankPayment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        ...
        function WarningMessage() {
            UYResult("Please Select a Bank Payment VoucherNo", "warning");
        }
            ...
            <div class="col-md-12">
                <div class="widget box">
                    <div class="widget-header">
                        <h4><i class="icon-reorder"></i>Payment Voucher (Bank)</h4>
                    </div>
