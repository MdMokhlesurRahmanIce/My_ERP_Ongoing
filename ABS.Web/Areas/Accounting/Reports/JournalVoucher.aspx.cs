    ...
    public partial class JournalVoucher : System.Web.UI.Page
    {
        ...
        private void BindPV(int companyId)
        {
            try
            {
                using (var db = new ERP_Entities())
                {
                    var source = db.AccVoucherMasters.Where(r => r.VoucherTypeId == 5 && r.CompanyId == companyId).ToList();
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ReportViewer1.Report = new JournalVoucherNew();

                    (ReportViewer1.Report as JournalVoucherNew).pvparam = cbPVNO.SelectedValue;
                    (ReportViewer1.Report as JournalVoucherNew).pvparam1 = ddlCompanyName.SelectedValue;
