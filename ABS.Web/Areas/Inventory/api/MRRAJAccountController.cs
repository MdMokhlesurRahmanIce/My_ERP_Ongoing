...
{
    [RoutePrefix("Inventory/api/MRRAJAccount")]
    public class MRRAJAccountController : ApiController
    {
        private iMRRAJAccountMgt objMRR = null;
        private iSystemCommonDDL objSystemCommonDDL = null;

        public MRRAJAccountController()
        {
            objMRR = new MRRAJAccountMgt();
