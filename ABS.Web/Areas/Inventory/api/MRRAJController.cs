...
{
    [RoutePrefix("Inventory/api/MRRAJ")]
    public class MRRAJController : ApiController
    {
        private iMRRAJMgt objMRRAJ = null;
           // private iMRRAJMgt objMRR = null;
            private iSystemCommonDDL objSystemCommonDDL = null;

            public MRRAJController()  
            {
                objMRRAJ = new MRRAJMgt();
            ...
            public List<vmRequisition> GetRequisitionItemList( int? RequisitionID)
            {
                ...
                try
                {
                    RequisitionItemList = objMRRAJ.GetRequisitionItemList(RequisitionID).ToList();
            ...
            public List<InvGrrMaster> GetGRRNo(int? pageNumber, int? pageSize, int? IsPaging)
            {
                ...
                try
                {
                    lstInvGrrMaster = objMRRAJ.GetGRRNo(pageNumber, pageSize, IsPaging); 
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetMrrType(object[] data) 
            {
                ...
                try
                {
                    ...
                    lstMrrType = objMRRAJ.GetMrrType(mrrType, objcmnParam);
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetSuppliers(object[] data)
            {
                ...
                try
                {
                    ...
                    lstSuppliers = objMRRAJ.GetSuppliers(objcmnParam);
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetIssueNo(object[] data)
            {
                ...
                {
                    vmCmnParameters objcmnParam = JsonConvert.DeserializeObject<vmCmnParameters>(data[0].ToString());
                    lstIssue = objMRRAJ.GetIssueNo(objcmnParam); 
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetSprLoanList(object[] data) 
            {
                ...
                try
                {
                    ...
                    lstSprLoan = objMRRAJ.GetSprLoanList(objcmnParam, loanTransTypeSpr);
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetMasterInfoByGrrNo(object[] data) 
            {
                ...
                { 
                    ...
                    lstMasterInfoByGrrNo = objMRRAJ.GetMasterInfoByGrrNo(objcmnParam, grrID, out recordsTotal);   
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetDetailInfoByGrrNo(object[] data)
            {
                ...
                {
                    Int64 grrID = Convert.ToInt64(data[1]);
                    lstDetailInfoByGrrNo = objMRRAJ.GetDetailInfoByGrrNo(objcmnParam, grrID, out recordsTotal);
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetMrrMasterList(object[] data)
            {
                ...
                try
                {
                    ...
                    lstMrrMaster = objMRRAJ.GetMrrMasterList(objcmnParam, out recordsTotal); 
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetQCListByGrrNo(object[] data)
            {
                ...
                {
                    Int64 grrID = Convert.ToInt64(data[1]);
                    lstQCByGrrNo = objMRRAJ.GetQCListByGrrNo(objcmnParam, grrID, out recordsTotal); 
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetQCList(object[] data)
            {
                ...
                try
                {
                    lstQCByGrrNo = objMRRAJ.GetQCList(objcmnParam, out recordsTotal);
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IEnumerable<InvMrrMaster> ChkDuplicateNo(object[] data) 
            {
                ...
                try
                {
                    ...
                    objNo = objMRRAJ.ChkDuplicateNo(objcmnParam, MNo);
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetWherehouseList(object[] data)
            {
                ...
                try
                {
                    lstWherehouse = objMRRAJ.GetWherehouseList(objcmnParam, out recordsTotal);
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetDetailInfoByQCID(object[] data) 
            {
                ...
                try
                {
                    ...
                    lstQC = objMRRAJ.GetDetailInfoByQCID(objcmnParam, QCID, out recordsTotal);
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetDetailInfoByLoanSprID(object[] data) 
            {
                ...
                try
                {
                    ...
                    lstQC = objMRRAJ.GetDetailInfoByLoanSprID(objcmnParam, LoanSprID, out recordsTotal); 
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetDetailInfoByIssueID(object[] data) 
            {
                ...
                try
                {
                    ...
                    lstIssue = objMRRAJ.GetDetailInfoByIssueID(objcmnParam, IssueID, out recordsTotal);
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public IHttpActionResult GetMrrDetailsListByMrrID(object[] data)
            {
                ...
                try
                {
                    ...
                    lstDetailInfoByMrrID = objMRRAJ.GetMrrDetailsListByMrrID(objcmnParam, mrrID, out recordsTotal); 
                }
                catch (Exception e)
                {
                    e.ToString();
            ...
            public HttpResponseMessage SaveUpdateMrrMasterNdetails(object[] data)
            {
                ...
                try 
                {
                    ...
                    {
                        result = objMRRAJ.SaveUpdateMrrMasterNdetails(mrrMaster, mrrDetails, menuID); 
                    }
                    else
                    {
                        result = "";
            ...
            public HttpResponseMessage SaveLot(object[] data) 
            {
                ...
                try
                {
                    ...
                    {
                        result = objMRRAJ.SaveLot(objCmnLot);
                    }
                    else
                    {
                        result = "";
            ...
            public HttpResponseMessage SaveBatch(object[] data) 
            {
                ...
                try
                {
                    ...
                    {
                        result = objMRRAJ.SaveBatch(objCmnBatch);
                    }
                    else
                    {
                        result = "";
