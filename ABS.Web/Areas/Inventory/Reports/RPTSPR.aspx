<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Inventory/Reports/RPTInventory.Master" AutoEventWireup="true" CodeBehind="RPTSPR.aspx.cs" Inherits="ABS.Web.Areas.Inventory.Reports.RPTSPR" %>
                ...
                <div class="widget box">
                    <div class="widget-header">
                        ...
                        <div class="toolbar no-padding">
                            ...
                            SPR No <asp:DropDownList ID="ddlSPRNO" runat="server" class="select2-select-00" Width="250px">
                                
                            </asp:DropDownList>
                            <div class="btn-group">
                                <asp:Button ID="btnShowReport" Text="Show Report" class="btn btn-success" runat="server" OnClick="btnShowReport_Click" />
                            </div>
                        </div>
                    </div>
