<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Inventory/Reports/RPTInventory.Master" AutoEventWireup="true" CodeBehind="RPTIssueDetail.aspx.cs" Inherits="ABS.Web.Areas.Inventory.Reports.RPTIssueDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphInventoryMaster" runat="server">
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">Issue Detail Report</h3>
