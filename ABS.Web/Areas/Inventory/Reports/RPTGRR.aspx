<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Inventory/Reports/RPTInventory.Master" AutoEventWireup="true" CodeBehind="RPTGRR.aspx.cs" Inherits="ABS.Web.Areas.Inventory.Reports.RPTGRR" %>
                ...
                <div class="widget box">
                    <div class="widget-header">
                        ...
                        <div class="toolbar no-padding">
                            ...
                            GRR NO <asp:DropDownList ID="ddlGRRNO" runat="server" class="select2-select-00" Width="250px">
