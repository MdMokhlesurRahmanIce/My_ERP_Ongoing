<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Inventory/Reports/RPTInventory.Master" AutoEventWireup="true" CodeBehind="RPTItem.aspx.cs" Inherits="ABS.Web.Areas.Inventory.Reports.RPTItem" %>
                ...
                <div class="widget box">
                    <div class="widget-header">
                        ...
                        <div class="toolbar no-padding">
                            ...
                            Item Type <asp:DropDownList ID="ddlItemType" runat="server" class="select2-select-00" Width="250px">
