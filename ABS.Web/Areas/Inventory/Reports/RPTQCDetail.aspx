<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Inventory/Reports/RPTInventory.Master" AutoEventWireup="true" CodeBehind="RPTQCDetail.aspx.cs" Inherits="ABS.Web.Areas.Inventory.Reports.RPTQCDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphInventoryMaster" runat="server">
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">QC Detail Report</h3>
