...
{
    public partial class RPTMRRDetail: System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            ...
            {
                ReportViewer1.Report = new rptMRRDetail();
                (ReportViewer1.Report as rptMRRDetail).startDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptMRRDetail).endDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtEndDate.Text);
                (ReportViewer1.Report as rptMRRDetail).createdBy = Convert.ToInt16(Session["UserID"]);
                (ReportViewer1.Report as rptMRRDetail).companyId = Convert.ToInt16(ddlCompany.SelectedValue);
