<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Inventory/Reports/RPTInventory.Master" AutoEventWireup="true" CodeBehind="RPTSR.aspx.cs" Inherits="ABS.Web.Areas.Inventory.Reports.RPTSR" %>
                ...
                <div class="widget box">
                    <div class="widget-header">
                        ...
                        <div class="toolbar no-padding">
                            ...
                            SR No <asp:DropDownList ID="ddlSRNO" runat="server" class="select2-select-00" Width="250px">
