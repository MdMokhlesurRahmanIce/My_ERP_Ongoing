...
{
    public partial class RPTSRDetail : System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            ...
            {
                ReportViewer1.Report = new rptSRDetail();
                (ReportViewer1.Report as rptSRDetail).startDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptSRDetail).endDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtEndDate.Text);
                (ReportViewer1.Report as rptSRDetail).createdBy = Convert.ToInt16(Session["UserID"]);
                (ReportViewer1.Report as rptSRDetail).companyId = Convert.ToInt16(ddlCompany.SelectedValue);
                (ReportViewer1.Report as rptSRDetail).RequisitionTypeID = 6;
