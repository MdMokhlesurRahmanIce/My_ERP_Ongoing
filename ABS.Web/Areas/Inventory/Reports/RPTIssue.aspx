<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Inventory/Reports/RPTInventory.Master" AutoEventWireup="true" CodeBehind="RPTIssue.aspx.cs" Inherits="ABS.Web.Areas.Inventory.Reports.RPTIssue" %>
                ...
                <div class="widget box">
                    <div class="widget-header">
                        ...
                        <div class="toolbar no-padding">
                            ...
                            Issue No <asp:DropDownList ID="ddlIssue" runat="server" class="select2-select-00" Width="250px">
