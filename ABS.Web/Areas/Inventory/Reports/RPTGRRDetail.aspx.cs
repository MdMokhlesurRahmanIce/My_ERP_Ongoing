...
{
    public partial class RPTGRRDetail : System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            ...
            {
                ReportViewer1.Report = new rptGRRDetail();
                (ReportViewer1.Report as rptGRRDetail).startDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptGRRDetail).endDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtEndDate.Text);
                (ReportViewer1.Report as rptGRRDetail).createdBy = Convert.ToInt16(Session["UserID"]);
                (ReportViewer1.Report as rptGRRDetail).companyId = Convert.ToInt16(ddlCompany.SelectedValue);
