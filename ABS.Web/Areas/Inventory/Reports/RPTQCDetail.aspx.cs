...
{
    public partial class RPTQCDetail : System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            ...
            {
                ReportViewer1.Report = new rptQCDetail();
                (ReportViewer1.Report as rptQCDetail).startDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptQCDetail).endDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtEndDate.Text);
                (ReportViewer1.Report as rptQCDetail).createdBy = Convert.ToInt16(Session["UserID"]);
                (ReportViewer1.Report as rptQCDetail).companyId = Convert.ToInt16(ddlCompany.SelectedValue);
