<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Inventory/Reports/RPTInventory.Master" AutoEventWireup="true" CodeBehind="RPTSPRDetail.aspx.cs" Inherits="ABS.Web.Areas.Inventory.Reports.RPTSPRDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphInventoryMaster" runat="server">
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">SPR Detail Report</h3>
