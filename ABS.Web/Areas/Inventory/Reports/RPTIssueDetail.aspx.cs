...
{
    public partial class RPTIssueDetail : System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            ...
            {
                ReportViewer1.Report = new rptISSDetail();
                (ReportViewer1.Report as rptISSDetail).startDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptISSDetail).endDate = UniqueCode.GetDateFormat_MM_dd_yyy(txtEndDate.Text);
                (ReportViewer1.Report as rptISSDetail).createdBy = Convert.ToInt16(Session["UserID"]);
                (ReportViewer1.Report as rptISSDetail).companyId = Convert.ToInt16(ddlCompany.SelectedValue);              
