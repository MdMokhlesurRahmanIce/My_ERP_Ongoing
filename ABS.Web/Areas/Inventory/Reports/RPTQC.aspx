<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Inventory/Reports/RPTInventory.Master" AutoEventWireup="true" CodeBehind="RPTQC.aspx.cs" Inherits="ABS.Web.Areas.Inventory.Reports.RPTQC" %>
                ...
                <div class="widget box">
                    <div class="widget-header">
                        ...
                        <div class="toolbar no-padding">
                            ...
                            QC NO <asp:DropDownList ID="ddlQCNO" runat="server" class="select2-select-00" Width="250px">
