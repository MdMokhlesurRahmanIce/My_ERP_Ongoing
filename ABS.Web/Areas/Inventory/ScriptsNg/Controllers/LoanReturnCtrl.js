...
app.controller('LoanReturnCtrl', ['$scope', 'IssueService', '$filter', 'uiGridConstants', 'conversion', '$localStorage',
    ...
    var LoginCompanyID = $scope.UserCommonEntity.loggedCompnyID;
        ...
        $scope.PageTitle = 'Loan Return';
        $scope.ListTitlePIDeatails = 'Issue Item (Details)';
        $scope.LabelIssueText = "Loan Return No:";
        $scope.LabelIssueby = " loan Return By:";
        $scope.LabelIssuedate = "Loan Return Date:";      
        $scope.divReqNo = false;
        $scope.divToCompany = true;
        $scope.divToDept = true;
        $scope.divFromDept = true;
        $scope.divMRR = true;
    ...
    $scope.ListTitle = 'Loan Issue Records';
    $scope.ListTitleActivePIMasters = 'Loan Issue  Information (Masters)';
    $scope.ListTitleSampleNo = 'Sample Info';
   // $scope.ListTitlePIDeatails = 'Issue Information (Details)';
    $scope.ListTitleRequisitioneatails = 'Loan Issue Item List';
        // $scope.ListTitleRequisitionMaster = 'Requisition List';
    $scope.ListTitleQCMasters = 'Issue Information (Masters)';
    $scope.ListTitleSampleNo = 'Sample Info';
    $scope.ListTitleQCDeatails = 'Loan Issue Information (Details)';
    $scope.btnModal = "Add";
    $scope.ListPIDetails = [];
    ...
    function loadRecords_Company(isPaging) {
        ...
        var apiRoute = '/Inventory/api/SPR/GetCompany/';
        var listComp = IssueService.GetAllCompany(apiRoute, page, pageSize, isPaging, $scope.UserCommonEntity.loggedCompnyID);
    ...
    $scope.save = function () {
        ...
        if (chkAmount == 1) {
            ...
            Command: toastr["warning"]("Loan Issue Quantity Must Not Zero Or Empty !!!!");
    ...
    function loadIssueMasterRecords(isPaging) {
        ...
        $scope.gridOptionsIssueMaster = {
            ...
            columnDefs: [
                ...
                { name: "IssueNo", displayName: "Loan Return No", title: "Issue No", width: '25%', headerCellClass: $scope.highlightFilteredHeader },
                { name: "IssueDate", displayName: "Loan Return Date", cellFilter: 'date:"dd-MM-yyyy"', width: '15%', headerCellClass: $scope.highlightFilteredHeader },
                { name: "IssueByName", displayName: "Loan Return By", title: "IssueBy", width: '25%', headerCellClass: $scope.highlightFilteredHeader },
                { name: "RequisitionNo", displayName: "Loan Order No", title: "Requisition No", width: '30%', headerCellClass: $scope.highlightFilteredHeader },            
                {
                    name: 'Option',
                    displayName: "Option",
