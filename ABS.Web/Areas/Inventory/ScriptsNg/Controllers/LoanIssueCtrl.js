...
app.controller('LoanIssueCtrl', ['$scope', 'IssueService', '$filter', 'uiGridConstants', 'conversion', '$localStorage',
    ...
    var LoginCompanyID = $scope.UserCommonEntity.loggedCompnyID;
        ...
        $scope.PageTitle = 'Loan Issue';
        $scope.ListTitlePIDeatails = 'Issue Item (Details)';
        $scope.LabelIssueText = "Loan Issue No:";
        $scope.LabelIssueby = " loan Issue By:";
        $scope.LabelIssuedate = "Loan Issue Date:";      
    ...
    function loadIssueMasterRecords(isPaging) {
        ...
        $scope.gridOptionsIssueMaster = {
            ...
            columnDefs: [
                ...
                { name: "IssueNo", displayName: "Loan Issue No", title: "Issue No", width: '25%', headerCellClass: $scope.highlightFilteredHeader },
                { name: "IssueDate", displayName: "Loan Issue Date", cellFilter: 'date:"dd-MM-yyyy"', width: '15%', headerCellClass: $scope.highlightFilteredHeader },
                { name: "IssueByName", displayName: "Loan Issue By", title: "IssueBy", width: '25%', headerCellClass: $scope.highlightFilteredHeader },
