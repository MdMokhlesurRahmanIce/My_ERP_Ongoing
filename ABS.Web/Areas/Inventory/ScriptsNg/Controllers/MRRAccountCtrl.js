...
app.controller('mRRAccountCtrl', ['$scope', 'mRRAccountService', 'qcService', 'RequisitionService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, mRRAccountService, qcService, RequisitionService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        function loadUserCommonEntity(num) {
            ...
            $scope.UserCommonEntity.currentTransactionTypeID = 32; // $localStorage.currentTransactionTypeID; // for transactiontyeid not duplicate 
        ...
        function chkTrnsTypeFHideShow() {
            if ($scope.UserCommonEntity.currentTransactionTypeID == 32) {  // for  only Loan  Mrr accounts
                ...
                $scope.PageTitle = 'Loan MRR Creation';
                $scope.ListTitle = 'Loan MRR Records';
                $scope.ListTitleMrrMasters = 'Loan MRR  Information (Masters)';
                $scope.ListTitleSampleNo = 'Sample Info';
                $scope.ListTitleMrrDeatails = 'Loan MRR Information (Details)';
            }
    

            else if ($scope.UserCommonEntity.currentTransactionTypeID == 10) {  // for  only Mrr accounts
        ...
        var baseUrl = '/Inventory/api/MRRAccount/';
        var isExisting = 0;
        var page = 0;
        var pageSize = 100;
        var isPaging = 0;
