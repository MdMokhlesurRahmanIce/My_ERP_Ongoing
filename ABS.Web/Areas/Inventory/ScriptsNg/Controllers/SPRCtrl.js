...
app.controller('SPRCtrl', ['$scope', 'RequisitionService', '$filter', 'uiGridConstants', 'conversion', '$localStorage',
    function ($scope, RequisitionService, $filter, uiGridConstants, conversion, $localStorage) {

        //Rq
        $scope.gridOptionsRequisition = [];
        var objcmnParam = {};
        var TransactionTypeId = 8;
        ...
        $scope.PageTitle = 'Store Purchase Requisition Creation';
        ...
        $scope.ListTitleRequisitioneatails = 'SPR Item List';
            ...
            if (getMNo.trim() != "") {
                ...
                getDuplicateNo.then(function (response) {
                    ...
                    if (response.data.length > 0) {
                        ...
                        $scope.ManualSPRNo = "";
                        Command: toastr["warning"]("Manual SPR No Already Exists.");
                    }
                },
                    function (error) {
                ...
                Command: toastr["warning"]("Please Enter Manual SPR No.");
            }
        ...
        function loadRequisition_Records(isPaging) {
            ...
            $scope.gridOptionsRequisition = {
                columnDefs: [
                    ...
                    { name: "RequisitionNo", title: "Requisition No", width: '15%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "ManualRequisitionNo", title: "Manual SPR No", width: '15%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "RequisitionDate", title: "Requisition Date", cellFilter: 'date:"dd-MM-yyyy"', width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                    ...
                    { name: "RequisitionByName", title: "Requisition By", width: '15%', headerCellClass: $scope.highlightFilteredHeader },
