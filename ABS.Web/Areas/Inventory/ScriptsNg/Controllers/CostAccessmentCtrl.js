...
app.controller('costAccessmentCtrl', ['$scope', 'gRRService', '$http', 'crudService', 'RequisitionService', 'mRRService', 'conversion', '$filter', '$localStorage', 'uiGridConstants',
    function ($scope, gRRService, $http, crudService, RequisitionService, mRRService, conversion, $filter, $localStorage, uiGridConstants) {
        ...
        var loggedCompany = $scope.UserCommonEntity.loggedCompnyID
        ...
        $scope.save = function () {
            ...
            else if ($scope.AccessmentDetail.length <= 0) {
                $("#save").prop("disabled", false);
