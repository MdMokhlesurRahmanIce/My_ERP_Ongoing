...
{
    public partial class LCBStopage : System.Web.UI.Page  
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            try
            {
                ReportViewer1.Report = new rptLCBStopage();
                ...
                (ReportViewer1.Report as rptLCBStopage).paramDateFrom = dateFrom; //UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptLCBStopage).paramDateTo = dateTo;
                (ReportViewer1.Report as rptLCBStopage).paramShift = shift; 
                (ReportViewer1.Report as rptLCBStopage).paramMachine = machine; 
                (ReportViewer1.Report as rptLCBStopage).companyId = company;
