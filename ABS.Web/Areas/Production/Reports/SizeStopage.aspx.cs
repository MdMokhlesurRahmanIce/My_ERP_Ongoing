...
{
    public partial class SizeStopage : System.Web.UI.Page  
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            try
            {
                ReportViewer1.Report = new rptSizeStopage();
                ...
                (ReportViewer1.Report as rptSizeStopage).paramDateFrom = dateFrom; //UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptSizeStopage).paramDateTo = dateTo;
                (ReportViewer1.Report as rptSizeStopage).paramShift = shift;
                (ReportViewer1.Report as rptSizeStopage).paramMachine = machine;
                (ReportViewer1.Report as rptSizeStopage).companyId = company;
