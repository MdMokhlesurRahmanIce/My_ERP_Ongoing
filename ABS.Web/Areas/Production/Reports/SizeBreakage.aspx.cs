...
{
    public partial class SizeBreakage : System.Web.UI.Page  
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            try
            {
                ReportViewer1.Report = new rptSizeBreakage();
                ...
                (ReportViewer1.Report as rptSizeBreakage).paramDateFrom = dateFrom; //UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptSizeBreakage).paramDateTo = dateTo;
                (ReportViewer1.Report as rptSizeBreakage).paramItem = item;
                (ReportViewer1.Report as rptSizeBreakage).paramSet = set;
                (ReportViewer1.Report as rptSizeBreakage).paramMachine = machine;
                (ReportViewer1.Report as rptSizeBreakage).paramOperator = pOperator;
