...
{
    public partial class BallProduction : System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            try
            {
                ReportViewer1.Report = new rptBallProduction();
                ...
                (ReportViewer1.Report as rptBallProduction).paramDateFrom = dateFrom; //UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptBallProduction).paramDateTo = dateTo;
                (ReportViewer1.Report as rptBallProduction).paramShift = shift;
                (ReportViewer1.Report as rptBallProduction).paramBuyer = buyer;
                (ReportViewer1.Report as rptBallProduction).paramPI = pi;
                (ReportViewer1.Report as rptBallProduction).paramItem = item;
                (ReportViewer1.Report as rptBallProduction).paramSet = set;
                (ReportViewer1.Report as rptBallProduction).paramMachine = machine;
                (ReportViewer1.Report as rptBallProduction).paramOperator = pOperator;
                (ReportViewer1.Report as rptBallProduction).companyId = company;
