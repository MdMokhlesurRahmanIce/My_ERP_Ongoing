<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Production/Reports/RPTProduction.Master" AutoEventWireup="true" CodeBehind="SizeProduction.aspx.cs" Inherits="ABS.Web.Areas.Production.Reports.SizeProduction" %>
                        ...
                        <div class="toolbar no-padding">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>Shift
                            <asp:DropDownList ID="ddlShift" runat="server" class="select2-select-00"
                                Width="100px">
                            </asp:DropDownList>
                                    </td>
                                      <td>Buyer
                            <asp:DropDownList ID="ddlBuyer" runat="server" class="select2-select-00"
                                Width="150px">
                            </asp:DropDownList>
                                    </td>
                                                 <td>PI
                            <asp:DropDownList ID="ddlPI" runat="server" class="select2-select-00"
                                Width="150px">
                            </asp:DropDownList>
                                    </td>
                                </tr>
                            ...
                            <asp:DropDownList ID="ddlItem" runat="server" class="select2-select-00"
                                Width="150px" OnSelectedIndexChanged="ddlItem_SelectedIndexChanged" AutoPostBack="True">
                                    ...
                                    <td>Set
                            <asp:DropDownList ID="ddlSet" runat="server" class="select2-select-00" Width="100px">
                            </asp:DropDownList>
                                    </td>
                                    <td>Machine
