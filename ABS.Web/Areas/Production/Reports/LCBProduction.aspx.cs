...
{
    public partial class LCBProduction : System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            try
            {
                ReportViewer1.Report = new rptLCBProduction();
                ...
                (ReportViewer1.Report as rptLCBProduction).paramDateFrom = dateFrom; //UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptLCBProduction).paramDateTo = dateTo;
                (ReportViewer1.Report as rptLCBProduction).paramShift = shift;
                (ReportViewer1.Report as rptLCBProduction).paramBuyer = buyer;
                (ReportViewer1.Report as rptLCBProduction).paramPI = pi;
                (ReportViewer1.Report as rptLCBProduction).paramItem = item;
                (ReportViewer1.Report as rptLCBProduction).paramSet = set;
                (ReportViewer1.Report as rptLCBProduction).paramMachine = machine;
                (ReportViewer1.Report as rptLCBProduction).paramOperator = pOperator;
                (ReportViewer1.Report as rptLCBProduction).companyId = company;
