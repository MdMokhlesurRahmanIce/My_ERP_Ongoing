...
{
    public partial class WeavingProductionDailyCodeWise : System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            try
            {
                ReportViewer1.Report = new rptWeavingProductionDailyCodeWise();
                ...
                (ReportViewer1.Report as rptWeavingProductionDailyCodeWise).paramDateFrom = dateFrom; //UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);    
                (ReportViewer1.Report as rptWeavingProductionDailyCodeWise).paramDateTo = dateTo;
                (ReportViewer1.Report as rptWeavingProductionDailyCodeWise).companyId = company;
