...
{
    public partial class WeavingWarpPerformanceAnalysis : System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            try
            {
                ReportViewer1.Report = new rptWeavingWarpPerformanceAnalysis();
                ...
                (ReportViewer1.Report as rptWeavingWarpPerformanceAnalysis).paramDateFrom = dateFrom; //UniqueCode.GetDateFormat_MM_dd_yyy(txtStartDate.Text);
                (ReportViewer1.Report as rptWeavingWarpPerformanceAnalysis).paramDateTo = dateTo;
                (ReportViewer1.Report as rptWeavingWarpPerformanceAnalysis).paramShift = shift;
                (ReportViewer1.Report as rptWeavingWarpPerformanceAnalysis).paramItem = item;
                (ReportViewer1.Report as rptWeavingWarpPerformanceAnalysis).paramSet = set;
                (ReportViewer1.Report as rptWeavingWarpPerformanceAnalysis).paramMachine = machine;
                (ReportViewer1.Report as rptWeavingWarpPerformanceAnalysis).paramOperator = pOperator;
                (ReportViewer1.Report as rptWeavingWarpPerformanceAnalysis).companyId = company;
