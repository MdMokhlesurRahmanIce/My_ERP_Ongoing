app.service('DyingChemicalConsumptionService', function ($http) {
    var urlGet = '';
    ...
    this.getDetailByID = function (apiRoute, companyID, loggedUser, ConsumptionID, headerToken) {
        // debugger
    ...
    //*********************** Get Master **************************************
    this.GetAllByMasterDetails = function (apiRoute, companyID, loggedUser, page, pageSize, isPaging, MasterID, DetailsID, headerToken) {
        // debugger
    ...
    //************** Post Master Details  ************
    this.postCommonMasterDetails = function (apiRoute, modelMaster, modelDetails, commonEntity, headerToken) {
    ...
    //************** Post Master Details  ************
    this.postCommonMaster = function (apiRoute, modelMaster, commonEntity, headerToken) {
