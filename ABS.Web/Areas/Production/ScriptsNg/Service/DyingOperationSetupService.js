app.service('DyingOperationSetupService', function ($http) {
    var urlGet = '';
    ...
    //************** Post Master Details Common Entitie  ************
    ...
    this.postMasterListWithCommonEntity = function (apiRoute, modelMaster, commonEntity, headerToken) {
        debugger
