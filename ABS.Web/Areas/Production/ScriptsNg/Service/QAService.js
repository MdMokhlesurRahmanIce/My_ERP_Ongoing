...
app.service('QaService', function ($http) {
    //**********----Get All Record----***************
    var urlGet = '';
    ...
    this.GetFabricInspactionDetail = function (apiRoute, page, pageSize, isPaging, CompanyID, ItemId,FromDate,ToDate) {

        urlGet = apiRoute + page + '/' + pageSize + '/' + isPaging + '/' + CompanyID + '/' + '/' + ItemId + '/' + '/' + FromDate + '/' + ToDate;
        return $http.get(urlGet);
    }
    ...
    this.postFebricInspection = function (apiRoute, PrdFinishingInspactionDetail, FinishingMaster) {
        // debugger
        var strFinal = "[" + JSON.stringify(PrdFinishingInspactionDetail) + "," + JSON.stringify(FinishingMaster) + "]";
