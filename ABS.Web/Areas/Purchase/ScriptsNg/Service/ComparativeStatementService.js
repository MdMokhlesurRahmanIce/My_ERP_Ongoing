...
app.service('ComparativeStatementService', function ($http) {
    ...
    this.getByQuotationId = function (apiRoute, QuotationId, CompanyID) {
    ...
    this.getQuotationByRequisitionID = function (apiRoute, objcmnParam) {
        var cmnParam = "[" + JSON.stringify(objcmnParam) + "]";
        var request = $http({
            method: "post",
            url: apiRoute,
