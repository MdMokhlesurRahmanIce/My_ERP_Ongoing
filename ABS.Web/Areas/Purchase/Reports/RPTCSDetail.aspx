<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Purchase/Reports/RPTPurchase.Master" AutoEventWireup="true" CodeBehind="RPTCSDetail.aspx.cs" Inherits="ABS.Web.Areas.Purchase.Reports.RPTCSDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPurchaseMaster" runat="server">
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <h3 class="box-title">CS Detail Report</h3>
