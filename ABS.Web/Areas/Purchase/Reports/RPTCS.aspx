<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Purchase/Reports/RPTPurchase.Master" AutoEventWireup="true" CodeBehind="RPTCS.aspx.cs" Inherits="ABS.Web.Areas.Purchase.Reports.RPTCS" %>
                ...
                <div class="widget box">
                    <div class="widget-header">
                        ...
                        <div class="toolbar no-padding">
                            ...
                            CS No <asp:DropDownList ID="ddlCSNo" runat="server" class="select2-select-00" Width="250px">
