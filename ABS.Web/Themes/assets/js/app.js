...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        //Custom Modification For When we use ng-repeat and need to trigger a jquery click event 
        $(document).on('click', '#sidebar-content ul > li > a', function (e) {
            // debugger
        ...
        //This Given Function has Been Modified because of enabling click event triger when we use ng-repeat
    ...
    var handleThemeSwitcher = function () {
        ...
        if ($.cookie) {
            ...
            {
                //Set theme-switcher dark Default
                //Custom Modification Recommanded by Reza Boss
                _changeTheme('dark');
            }
        }
    }
