...
{
    public class MRRAccountMgt : iMRRAccountMgt
    {
                        ...
                        try
                        {
                            ...
                            if (mrrMaster.IsApproved == true && chkFirstNtfier == false)  
                            {
                                ...
                                if (AcDetailID!= null && AcDetailID != 0)
                                {
                                    ...
                                    lstVchrDCmnItm = lstVchrD.GroupBy(l => l.AC5Id)
                                                                .Select(cl => new AccVoucherDetail
                                                                {
                                                                    AC5Id = cl.First().AC5Id,
                                                                    CreditAmount = (decimal)cl.Sum(c => c.CreditAmount),
                                                                    DebitAmount = (decimal)cl.Sum(c => c.DebitAmount),
                                                                    CostCenterId = cl.First().CostCenterId,
                                                                    TransactionType = cl.First().TransactionType,
                                                                    VMasterId = (int)cl.First().VMasterId,
                                                                    VoucherNo = cl.First().VoucherNo,
