...
namespace ABS.Models
{
    ...
    public partial class PrdFinishingChemicalSetup
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public PrdFinishingChemicalSetup()
        {
            this.PrdFinishingChemicalSetupDetails = new HashSet<PrdFinishingChemicalSetupDetail>();
        }
    
        public int FinChemicalStupID { get; set; }
        public int FinChemicalStupNo { get; set; }
        public Nullable<int> FinishingProcessID { get; set; }
